...
class Car(db.Model, Serializer):
	"""
        ...
        Attributes:
        	...
        	available_status (bool) : Its true, if car is available for booking else, its set to false.
	"""
    ...
    def distance_travelled(current_latitude, current_longitude, original_car_location):
    	"""
    		...
    		Args:
        		...
        		original_car_location (Car) : Instance of Car class. Gives just previous location of car i.e location at the time of booking.
    	"""
